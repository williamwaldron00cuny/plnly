...
function paths(name, coral) {
  ...
  switch (name) {
    ...
    case 'orbit': // the brand motif, as a glyph
      return (<>
...
export function Icon({ name = 'ring', size = 24, coral = false, style, ...rest }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      style={{ display: 'inline-block', verticalAlign: 'middle', flex: 'none', ...style }} {...rest}>
      {paths(name, coral)}
    </svg>
  );
}

export const ICON_NAMES = ['ring', 'focus', 'time', 'plan', 'handover', 'add', 'place', 'orbit'];
