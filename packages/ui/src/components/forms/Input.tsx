...
/**
 * A calm text field — hairline border that warms to ink on focus. Mono label
 * above; coral reserved for error only.
 */
export function Input({ label, hint, error, id, style, containerStyle, onFocus, onBlur, ...rest }: InputProps) {
